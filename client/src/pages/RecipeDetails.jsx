      ...
      {isEditing ? (
        ...
        <>
          ...
          <div className={styles.ratingSection}>
            <RatingStars initialRating={currentRecipe.averageRating} onRating={handleRate} />
            <p>דירוג ממוצע: {currentRecipe.averageRating.toFixed(1)}</p>
          </div>
          
          <img src={currentRecipe.image} alt={currentRecipe.name} className={styles.recipeImage} />
